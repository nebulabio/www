...
var connect__delegate = function (url,p__6004){
var vec__6006 = p__6004;
var opts = cljs.core.nth.call(null,vec__6006,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__6006,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__6006,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__6006,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__6006,opts){
return (function (evt){
...
var G__6007__i = 0, G__6007__a = new Array(arguments.length -  1);
while (G__6007__i < G__6007__a.length) {G__6007__a[G__6007__i] = arguments[G__6007__i + 1]; ++G__6007__i;}
  p__6004 = new cljs.core.IndexedSeq(G__6007__a,0);
} 
return connect__delegate.call(this,url,p__6004);};
connect.cljs$lang$maxFixedArity = 1;
connect.cljs$lang$applyTo = (function (arglist__6008){
var url = cljs.core.first(arglist__6008);
var p__6004 = cljs.core.rest(arglist__6008);
return connect__delegate(url,p__6004);
});
