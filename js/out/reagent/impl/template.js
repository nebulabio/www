...
var G__11267 = o;
(G__11267[reagent.impl.template.cached_prop_name(k)] = convert_prop_value(v));
...
var old_11271 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_(old_11271))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_11271)].join(''):class$));
} else {
}
...
var res = (function (){var G__11273 = e;
return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__11273) : on_change.call(null,G__11273));
})();
...
var G__11276 = jsprops;
(G__11276["defaultValue"] = value);

(G__11276["onChange"] = ((function (G__11276,v,value,on_change){
return (function (p1__11274_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__11274_SHARP_);
});})(G__11276,v,value,on_change))
);
...
var G__11277 = argv;
var G__11278 = comp;
var G__11279 = jsprops;
var G__11280 = first_child;
return (reagent.impl.template.make_element.cljs$core$IFn$_invoke$arity$4 ? reagent.impl.template.make_element.cljs$core$IFn$_invoke$arity$4(G__11277,G__11278,G__11279,G__11280) : reagent.impl.template.make_element.call(null,G__11277,G__11278,G__11279,G__11280));
})], null);
...
var G__11285 = argv;
var G__11286 = comp;
var G__11287 = jsprops;
var G__11288 = first_child;
return (reagent.impl.template.reagent_input_class.cljs$core$IFn$_invoke$arity$4 ? reagent.impl.template.reagent_input_class.cljs$core$IFn$_invoke$arity$4(G__11285,G__11286,G__11287,G__11288) : reagent.impl.template.reagent_input_class.call(null,G__11285,G__11286,G__11287,G__11288));
});
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){
var vec__11290 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11290,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11290,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11290,(2),null);
...
var temp__4425__auto__ = (function (){var G__11292 = cljs.core.meta(v);
var G__11292__$1 = (((G__11292 == null))?null:reagent.impl.template.get_key(G__11292));
return G__11292__$1;
})();
if((temp__4425__auto__ == null)){
...
var jsprops = {"argv": v};
var G__11294_11295 = v;
var G__11294_11296__$1 = (((G__11294_11295 == null))?null:reagent.impl.template.key_from_vec(G__11294_11295));
var G__11294_11297__$2 = (((G__11294_11296__$1 == null))?null:(jsprops["key"] = G__11294_11296__$1));
...
var G__11305 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input,argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__11305) : reagent.impl.template.as_element.call(null,G__11305));
} else {
var p = (function (){var temp__4425__auto__ = (function (){var G__11306 = cljs.core.meta(argv);
var G__11306__$1 = (((G__11306 == null))?null:reagent.impl.template.get_key(G__11306));
return G__11306__$1;
})();
if((temp__4425__auto__ == null)){
return jsprops;
...
var G__11307 = (((jsprops == null))?{}:jsprops);
(G__11307["key"] = key);
...
var G__11309 = comp;
var G__11310 = p;
var G__11311 = first_child;
return (reagent.impl.template.make_element.cljs$core$IFn$_invoke$arity$4 ? reagent.impl.template.make_element.cljs$core$IFn$_invoke$arity$4(G__11308,G__11309,G__11310,G__11311) : reagent.impl.template.make_element.call(null,G__11308,G__11309,G__11310,G__11311));
}
} else {
return null;
}
...
var G__11314 = x;
return (reagent.impl.template.expand_seq_check.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.expand_seq_check.cljs$core$IFn$_invoke$arity$1(G__11314) : reagent.impl.template.expand_seq_check.call(null,G__11314));
...
var n__4652__auto___11316 = a.length;
var i_11317 = (0);
while(true){
if((i_11317 < n__4652__auto___11316)){
(a[i_11317] = reagent.impl.template.as_element((a[i_11317])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4652__auto___11319 = a.length;
var i_11320 = (0);
while(true){
if((i_11320 < n__4652__auto___11319)){
var val_11321 = (a[i_11320]);
if((cljs.core.vector_QMARK_(val_11321)) && ((reagent.impl.template.key_from_vec(val_11321) == null))){
(o["no-key"] = true);
} else {
}

(a[i_11320] = reagent.impl.template.as_element(val_11321));

var G__11322 = (i_11320 + (1));
i_11320 = G__11322;
continue;
} else {
}
...
var G__11324 = (cljs.core.count(argv) - first_child);
switch (G__11324) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__11324){
